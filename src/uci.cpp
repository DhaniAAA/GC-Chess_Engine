...
void UCIHandler::cmd_uci() {
    ...
    std::cout << "option name KnightAttackWeight type spin default " << Tuning::KnightAttackWeight << " min 0 max 15" << std::endl;
    std::cout << "option name BishopAttackWeight type spin default " << Tuning::BishopAttackWeight << " min 0 max 15" << std::endl;
    std::cout << "option name RookAttackWeight type spin default " << Tuning::RookAttackWeight << " min 0 max 15" << std::endl;
    std::cout << "option name QueenAttackWeight type spin default " << Tuning::QueenAttackWeight << " min 0 max 15" << std::endl;
    std::cout << "option name InnerRingAttackWeight type spin default " << Tuning::InnerRingAttackWeight << " min 0 max 10" << std::endl;
    std::cout << "option name OuterRingAttackWeight type spin default " << Tuning::OuterRingAttackWeight << " min 0 max 10" << std::endl;
    std::cout << "option name PawnShieldBonus1 type spin default " << Tuning::PawnShieldBonus[1] << " min 0 max 100" << std::endl;
    std::cout << "option name PawnShieldBonus2 type spin default " << Tuning::PawnShieldBonus[2] << " min 0 max 100" << std::endl;
    std::cout << "option name PawnShieldBonus3 type spin default " << Tuning::PawnShieldBonus[3] << " min 0 max 100" << std::endl;
    std::cout << "option name KingOpenFilePenaltyMG type spin default " << Tuning::KingOpenFilePenalty.mg << " min 0 max 60" << std::endl;
    std::cout << "option name KingOpenFilePenaltyEG type spin default " << Tuning::KingOpenFilePenalty.eg << " min 0 max 30" << std::endl;
    std::cout << "option name KingSemiOpenFilePenaltyMG type spin default " << Tuning::KingSemiOpenFilePenalty.mg << " min 0 max 60" << std::endl;
    std::cout << "option name KingSemiOpenFilePenaltyEG type spin default " << Tuning::KingSemiOpenFilePenalty.eg << " min 0 max 30" << std::endl;
    std::cout << "option name SafeCheckKnight type spin default " << Tuning::SafeCheckBonus[2] << " min 0 max 15" << std::endl;
    std::cout << "option name SafeCheckBishop type spin default " << Tuning::SafeCheckBonus[3] << " min 0 max 15" << std::endl;
    std::cout << "option name SafeCheckRook type spin default " << Tuning::SafeCheckBonus[4] << " min 0 max 15" << std::endl;
    std::cout << "option name SafeCheckQueen type spin default " << Tuning::SafeCheckBonus[5] << " min 0 max 15" << std::endl;
    std::cout << "option name HangingPawnPenaltyMG type spin default " << Tuning::HangingPawnPenalty.mg << " min -100 max 0" << std::endl;
    std::cout << "option name HangingPawnPenaltyEG type spin default " << Tuning::HangingPawnPenalty.eg << " min -100 max 0" << std::endl;
    std::cout << "option name HangingPawnThreatMG type spin default " << Tuning::HangingPawnWithThreat.mg << " min -50 max 50" << std::endl;
    std::cout << "option name HangingPawnThreatEG type spin default " << Tuning::HangingPawnWithThreat.eg << " min -50 max 50" << std::endl;
    std::cout << "option name InnerRingWeakPenalty type spin default " << Tuning::InnerRingWeakSquarePenalty << " min 0 max 50" << std::endl;
    std::cout << "option name OuterRingWeakPenalty type spin default " << Tuning::OuterRingWeakSquarePenalty << " min 0 max 50" << std::endl;
    std::cout << std::endl;
...
void UCIHandler::cmd_setoption(std::istringstream& is) {
    ...
    else if (name == "KnightAttackWeight") Tuning::KnightAttackWeight = std::stoi(value);
    else if (name == "BishopAttackWeight") Tuning::BishopAttackWeight = std::stoi(value);
    else if (name == "RookAttackWeight") Tuning::RookAttackWeight = std::stoi(value);
    else if (name == "QueenAttackWeight") Tuning::QueenAttackWeight = std::stoi(value);
    else if (name == "InnerRingAttackWeight") Tuning::InnerRingAttackWeight = std::stoi(value);
    else if (name == "OuterRingAttackWeight") Tuning::OuterRingAttackWeight = std::stoi(value);
    else if (name == "PawnShieldBonus1") Tuning::PawnShieldBonus[1] = std::stoi(value);
    else if (name == "PawnShieldBonus2") Tuning::PawnShieldBonus[2] = std::stoi(value);
    else if (name == "PawnShieldBonus3") Tuning::PawnShieldBonus[3] = std::stoi(value);
    else if (name == "KingOpenFilePenaltyMG") Tuning::KingOpenFilePenalty.mg = std::stoi(value);
    else if (name == "KingOpenFilePenaltyEG") Tuning::KingOpenFilePenalty.eg = std::stoi(value);
    else if (name == "KingSemiOpenFilePenaltyMG") Tuning::KingSemiOpenFilePenalty.mg = std::stoi(value);
    else if (name == "KingSemiOpenFilePenaltyEG") Tuning::KingSemiOpenFilePenalty.eg = std::stoi(value);
    else if (name == "SafeCheckKnight") Tuning::SafeCheckBonus[2] = std::stoi(value);
    else if (name == "SafeCheckBishop") Tuning::SafeCheckBonus[3] = std::stoi(value);
    else if (name == "SafeCheckRook") Tuning::SafeCheckBonus[4] = std::stoi(value);
    else if (name == "SafeCheckQueen") Tuning::SafeCheckBonus[5] = std::stoi(value);
    else if (name == "HangingPawnPenaltyMG") Tuning::HangingPawnPenalty.mg = std::stoi(value);
    else if (name == "HangingPawnPenaltyEG") Tuning::HangingPawnPenalty.eg = std::stoi(value);
    else if (name == "HangingPawnThreatMG") Tuning::HangingPawnWithThreat.mg = std::stoi(value);
    else if (name == "HangingPawnThreatEG") Tuning::HangingPawnWithThreat.eg = std::stoi(value);
    else if (name == "InnerRingWeakPenalty") Tuning::InnerRingWeakSquarePenalty = std::stoi(value);
    else if (name == "OuterRingWeakPenalty") Tuning::OuterRingWeakSquarePenalty = std::stoi(value);
